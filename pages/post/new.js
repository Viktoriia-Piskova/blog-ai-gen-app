...
export default function NewPost(props) {
  ...
  return (
    <div className="h-full overflow-hidden">
      { !!isGenerating && (<div className="text-green-500 flex h-full w-full animate-pulse flex-col justify-center items-center">
        <FontAwesomeIcon className="text-8xl" icon={faBrain}/>
        <h2>Generating...</h2>
      </div>)}
      {!isGenerating && (<div className="w-full h-full flex flex-col overflow-auto px-4">
        <form
